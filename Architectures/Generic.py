...
class Generator(nn.Module):
	"""
		Provides an architecture for Generator for any image based dataset. This produces images of size image_size x image_size
...
class Discriminator(nn.Module):
	"""
		Provides an architecture for Discriminator for any image based dataset. This discriminates images of size image_size x image_size
		Use this module if you are using a very new dataset.
		Motivated by DCGAN by Alec Radford et al.
	"""
