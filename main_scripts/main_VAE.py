...
# Please look at the documentation of the loader functions using help(d_u) command.
...
# VAE object initialization
# Parameters below can be modified
# Please check the documentation using help(VAE.VAE.__init__)
image_size = 32
n_z = 128
hiddens = {'enc': 64, 'dec': 64}
ngpu = 1
loss = ['BCE', 'KLD']

Gen_model = VAE.VAE(image_size=image_size, n_z=n_z, n_chan=n_chan, hiddens=hiddens, ngpu=ngpu, loss=loss)

# VAE training scheme
# Parameters below can be modified based on required usage.
# Please check the documentation using help(VAE.VAE.train) for more details
